...
\addplot[
    ...
    coordinates {
    (.25,97.98387)(.5,98.15167)(.75,98.21007)(1,98.24800)(2,98.28778913254116)(2.5,98.431968)(3,98.451494)(3.5,98.452746)(5,98.363250)(7.5,98.358220)(10,98.343130)
    };
...
\addplot[
    ...
    coordinates {
    (.25,97.20791)(.5,97.25249)(.75,97.38109)(1.0,97.49125)(2.00,97.596942)(2.5,97.630838)(3,97.645504)(5,97.577240)(7.5,97.56557)
    };
...
\addplot[
    ...
    coordinates {
    (.25,98.70934)(.50,98.76605)(.75,98.79450)(1.00,98.83654)(2.00,98.876740)(2.5,98.881560)(3,98.915430)(3.5,98.946450)(4,98.965340)(4.5,98.978710)(5,98.981940)(7.5,99.0111100)(10,99.01083)
    };
\legend{Bid, Ask, Price}
...
Again, we compare our results with the actual bid and ask prices extracted from the UBS platform. Figure \ref{fig:results-multi-BRC-pricing} sums up the results:
...
\addplot[
    ...
    coordinates {
    (.25,98.118750)(.5,98.222870)(.75,98.350130)(1.0,98.425353)(2.0,98.478750)(2.5,98.45757)(3,98.40819)(3.5,98.44820)(5,98.43820461)
    };
    \legend{Bid, Ask, Price}								
\end{axis}
\end{tikzpicture}
...
\addplot[
    ...
    coordinates {
    (0,101.61)(10.00,101.61)
    };
\addplot[
    color=red,
    ]
    coordinates {
    (0,102.11)(10.00,102.11)
    };
\addplot[
    color=cyan,
    mark=o,
    ...
    coordinates {
    (.25,103.1411028)(.5,103.1517035)(.75,103.1552361)(1.0,103.1570022)(2.0,103.15965)(2.5,103.16018)(3,103.16053)
    };
    \legend{Bid, Ask, Price} 						
\end{axis}
\end{tikzpicture}
...
\begin{axis}[
    ...
    ylabel={Price (\%)},
    xmin=0, xmax=10.00,
    ymin=96.75, ymax=98.50,
    xtick={1,5,10},
    xticklabels={10000,50000,100000},
    ytick={96.75,97,97.25,97.50,97.75,98.0,98.25,98.50},
...
\addplot[
    ...
    coordinates {
    (.25,96.91363)(.50,97.19268)(.75,97.40514)(1.00,97.53649)(2.00,97.674000)(3,97.736250)(5,97.684733)
    };					
\legend{Bid, Ask, Price}
\end{axis}
\end{tikzpicture}
...
\addplot[
    ...
    coordinates {
    (.25,98.429)(.5,98.433)(.75,98.562)(1.00,98.651)(2.00,98.7422)(5,98.564951)(7.5,98.58418535)(10,98.60384949)
    };
\legend{Bid, Ask, Price}
...
\addplot[
    ...
    coordinates {
    (.25,99.02642)(.50,99.08632)(.75,99.12554)(1.00,99.15415)(2.00,99.201360)(5.00,99.287253)(7.5,99.28632497052063)(10,99.2887884)
    };					
\legend{Bid, Ask, Price}
...
\addplot[
    ...
    coordinates {
    (.5,98.311044)(1.0,98.507231)(2.0,98.565235)(3.0,98.507119)(5.0,98.521713)(75.0,98.44991)(100.0,98.39018)
    };
    \legend{Bid, Ask, Price}
...
\addplot[
    ...
    coordinates {
    (.5,103.1521)(1.0,103.1569)(2.0,103.1596)(3.0,103.1604)(5.0,103.1611)(75.0,103.1615)(100.0,103.1616)
    };
...
\addplot[
    ...
    coordinates {
    (.5,98.41049)(1.0,98.48714)(2.0,98.53243)(3.0,98.51124)(5.0,98.5433)(75.0,98.53293)(100.0,98.55739)
    };
     \legend{Bid, Ask, Price} 
\end{axis}
\end{tikzpicture}
