...
\cmidrule(l){2-7} 
BRC & Underlying & Volatility & Strike\footnote{this is also the initial level of the underlying} & Barrier Level & Coupon Rate & Maturity\\ % Column names row
\midrule % In-table horizontal line
...
& \multicolumn{6}{c}{Characteristics} \\ 
\cmidrule(l){2-7} 
BRC & Underlyings & Volatility & Strike\footnote{this is also the initial level of the underlying} & Barrier Level & Coupon Rate & Maturity\\ % Column names row
\midrule % In-table horizontal line
