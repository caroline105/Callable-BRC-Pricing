...
\addplot[
    ...
    coordinates {
    (.25,97.98387)(.5,98.15167)(.75,98.21007)(1,98.24800)(2,98.28778913254116)
    };
...
Again, we compare our results with the actual price extracted from the UBS platform. Figure \ref{fig:results-multi-BRC-pricing} sums up the average absolute error obtained on 20 simulations :
