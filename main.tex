...
\addplot[
    ...
    coordinates {
    (2500,97.98387)(5000,98.15167)(7500,98.21007)(10000,98.24800)
    };
...
Again, we compare our results with the real bid and ask extracted from the UBS platform. Figure \ref{fig:results-multi-BRC-pricing} sums up the results obtained on 100 simulations :
...
\end{tikzpicture}
\end{minipage}
\caption{Results of the pricing on callable multi-BRCs with the Gregory-Delbourgo interpolation}
